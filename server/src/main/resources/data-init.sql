...
INSERT INTO services (
    name, description, detailed_description, icon, category, features, pricing,
    owner_id, is_active, is_featured, display_order, created_at, modified_at
) VALUES
-- SaaS & Web System Development (CORE SERVICE)
(
    'SaaS & Web System Development',
    'Building scalable multi-platform systems (Web, H5, App), multi-tenant SaaS architectures, and custom enterprise solutions like TrainAdmin & LIMS.',
    'Specializing in end-to-end SaaS platform development with multi-tenant architecture support. Experience includes building comprehensive systems for training institutions, laboratory management, and e-commerce platforms. Expertise in Vue.js, Node.js, PHP, and cloud deployment strategies.',
    'el-icon-monitor',
    'development',
    '["Multi-platform Development", "SaaS Architecture", "CRMEB Customization", "Multi-tenant Systems", "API Integration", "Cloud Deployment"]',
...
(
    'Backend & Architecture',
    'Specializing in robust backend solutions and scalable architecture using PHP, Python, and Node.js.',
    'Designing and implementing scalable backend architectures for web applications and APIs. Expertise includes RESTful and GraphQL API development, database design and optimization, microservices architecture, and cloud infrastructure setup. Proficient in PHP (Laravel, CodeIgniter), Python (Django, Flask), and Node.js (Express, NestJS).',
    'el-icon-coin',
    'development',
    '["PHP Development", "Python Development", "Node.js Development", "Docker", "Database Design", "API Architecture"]',
...
(
    'AI Integration & Prototyping',
    'Leveraging modern AI APIs (ChatGPT, Claude) and models for intelligent business solutions and prototypes.',
    'Integrating AI capabilities into existing systems and building AI-powered prototypes. Experience with OpenAI GPT, Anthropic Claude, and other LLM APIs. Services include AI chatbot development, content generation automation, intelligent data processing, and rapid prototyping of AI features for business applications.',
    'el-icon-cpu',
    'development',
    '["LLM APIs", "AI Agents", "Prototyping", "Chatbot Development", "Content Generation", "AI Automation"]',
...
(
    'System Consulting Services',
    'Guiding technical design, architecture planning, and MVP roadmapping for optimal performance.',
    'Providing expert technical consulting for system design, architecture planning, and development roadmaps. Services include ER diagram design, data flow diagrams (DFD), system architecture documentation, technology stack recommendations, and MVP planning. Helping businesses make informed technical decisions.',
    'el-icon-data-analysis',
    'consulting',
    '["ER Diagrams", "DFD", "Architecture Planning", "Technology Consulting", "MVP Roadmapping", "System Design"]',
    'Hourly Rate or Fixed-price',
    @owner_id,
    TRUE,
    FALSE,
...
-- Website Design & Product Sites
(
    'Website Design & Product Sites',
    'Creating beautiful product websites with a focus on modern design, SEO, and internationalization.',
    'Designing and developing modern, responsive product websites and landing pages. Focus on user experience, SEO optimization, and internationalization (i18n). Experience with Figma for design, VuePress for documentation sites, and modern CSS frameworks. Creating websites that convert visitors into customers.',
    'el-icon-document',
    'design',
    '["Figma Design", "VuePress", "SEO", "Responsive Design", "Internationalization", "Landing Pages"]',
    'Fixed-price',
    @owner_id,
    TRUE,
    FALSE,
...
(
    'Mobile Application Development',
    'Cross-platform iOS and Android application development using the efficient UniApp framework.',
    'Developing cross-platform mobile applications using UniApp framework, enabling code sharing between iOS and Android platforms. Services include native-like mobile app development, API integration, push notifications, and app store deployment. Efficient development process reducing time and cost.',
    'el-icon-mobile-phone',
    'development',
    '["UniApp", "iOS Development", "Android Development", "Cross-platform", "API Integration", "App Store Deployment"]',
    'Fixed-price or Monthly Retainer',
    @owner_id,
    TRUE,
    FALSE,
...
(
    'Technical Consultant',
    'Expert technical support, code reviews, and long-term remote partnerships for your team.',
    'Providing ongoing technical support and consulting services for development teams. Services include code reviews, refactoring guidance, technical mentoring, architecture improvements, and long-term remote partnerships. Helping teams improve code quality, maintainability, and development efficiency.',
    'el-icon-user',
    'consulting',
    '["Code Review", "Refactoring", "Remote Support", "Technical Mentoring", "Team Collaboration", "Long-term Partnership"]',
...
(
    'Custom Automation Tools',
    'Developing bespoke automation tools to streamline workflows and boost business efficiency.',
    'Building custom automation tools and scripts to automate repetitive tasks and streamline business workflows. Services include workflow automation, scheduled task development, data processing automation, and integration tools. Helping businesses save time and reduce manual errors through intelligent automation.',
    'el-icon-setting',
    'development',
    '["Workflow Automation", "Scheduling", "Task Automation", "Data Processing", "Integration Tools", "Custom Scripts"]',
    'Fixed-price or Hourly Rate',
    @owner_id,
    TRUE,
    FALSE,
